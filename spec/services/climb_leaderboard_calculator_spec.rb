...
describe ClimbLeaderboardCalculator do
  describe '.calculate_for_club' do
    it 'generates leaderboards based on club data' do
      ...
      athlete = double("athlete", :rides_for_month_year => rides, :name => 'Kevin Climber', :total_elevation_for_month_year => 1000, :average_elevation_per_ride_for_month_year => 100)
